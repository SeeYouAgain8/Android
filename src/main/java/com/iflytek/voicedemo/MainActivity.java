...
import com.iflytek.voicedemo.voiceImp.VoiceT2V;
import com.iflytek.voicedemo.voiceImp.VoiceV2T;
...
public class MainActivity extends Activity implements OnClickListener, VoiceV2T.ResultCallback{
    private VoiceT2V t2v = new VoiceT2V();
    private IVoiceV2T v2t = new VoiceV2T();
    ...
    public void onReusltCallbcak(String result) {
        System.out.println("在这里执行下一步！！！！"+result);
    ...
    public void onClick(View view) {
        ...
        switch (tag) {
          ...
          /*  case 1:
            ...
            case 2:
                // 测试文字转语音接口
//                VoiceT2V.ACCESSIBILITY_SERVICE;
                String path = t2v.getT2V_return_Path(this,"王松、松松是全宇宙非完美信息博弈第一人,没问题的！");
                System.out.println("path ------"+path);
                break;
            case 3:
                // 测试语音转文字接口
                v2t.getVoiceToText(this,"/storage/emulated/0/tts.wav");
                break;
    ...
    String items[] = {"立刻体验语音听写"/*,, "立刻体验语法识别", "立刻体验语义理解"*/, "立刻体验语音合成"/*,
            "立刻体验语音评测", "立刻体验语音唤醒", "立刻体验声纹密码", "立刻体验人脸识别""重置域名"*/,"语音合成接口测试","语音转写接口测试"};
...
//                PermissionUtils.permission(PermissionConstants.STORAGE, PermissionConstants.LOCATION, PermissionConstants.PHONE, PermissionConstants.MICROPHONE).callback(new PermissionUtils.SimpleCallback() {
//                    @Override
